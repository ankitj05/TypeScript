...
function combine1(input1: (number | string), input2: (number | string), convertedResult : 'as-text' | 'as-number'){
    let result;
    if(typeof input1 == 'number' && typeof input2 == 'number'){
        result = input1 + input2
    }
...
const combineNumber1 = combine1(10, 40, 'as-number')
console.log(combineNumber)

const combineText1 = combine1('Hello ', 'World', 'as-text')
console.log(combineText)

const combineTextNumber = combine1(45, 21, 'as-text' )
